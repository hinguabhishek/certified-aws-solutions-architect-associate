...
- Access Points:
    ...
    - It has its own access point policy like bucket policy
    - We required VPC endpoint and VPC endpoint policy must allow access to bucket and end Access point to connect to bucket using VPC Origin
